...
<%
    ...
    if("submit".equals(type)){
        ...
        if(filename != null){
            ...
            cmdResult = strbuff.toString();
            session.setAttribute("result",cmdResult);
        }
    }else if(("refresh").equals(type)){
        cmdResult = (String)session.getAttribute("result");
    }else{
        cmdResult = "";
    }
...
function refresh(){
    window.location.href = "test06.jsp";
}
...
function show_result(filename){
    loadResult("test06.jsp",filename);
}
...
function cfunc()
{
    if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
            ...
            window.location.href = "test06.jsp?type=refresh";
    }
}
      ...
      public void run() {
        ...
        public void excutCMD(int cmdId,String cmd,String[] envp,String dir,String writeTime,String keyTemp){
            ...
            try {
                ...
                writeFile(resultFileName,"StartTime: " + writeTime,true);
                ...
                while ((line = error.readLine()) != null) {
                    if(errorNum == 0){
                        ...
                        writeFile(errorFileName,"StartTime: " + writeTime,true);
                        errorNum++;
                    }
