...
<%
    ...
    if(cmd != null){
        ...
        PrimeThread pt = new PrimeThread(cmd,envp,dir);
        pt.start();
...
function myFunction()
{
	...
	loadXMLDoc("test03.jsp",function()
	{
...
function show_result(filename){
    ...
    xmlhttp.onreadystatechange=cfunc;
    xmlhttp.open("POST","test03.jsp",true);
    xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
...
<%!
  ...
  public class PrimeThread extends Thread {
      ...
      PrimeThread(String cmd,String[] envp,String dir) {
          this.cmd = cmd;
          this.envp = envp;
          this.dir = dir;
      }
      ...
      public void run() {
    	  test03_jsp.this.cmdRuslte = excutCMD(cmd,envp,dir);
      }
    
    
        public String excutCMD(String cmd,String[] envp,String dir){
            ...
            try {
                ...
                while ((line = input.readLine()) != null) {
                    ...
                    writeFile("result_" + cmdReplace + writeTempReplace,line,true);
                }
                while ((line = error.readLine()) != null) {
                    buffer.append(line + "<br>");
                    writeFile("error_" +  cmdReplace + writeTempReplace,line,true);
                }
                ...
                writeFile("result_" + cmdReplace + writeTempReplace,"执行完毕时间: " + nowDate,true);
            } catch (Exception e) {
                nowDate = getTime();
                writeFile(keyTemp,cmd + "~@~执行完毕~@~" + writeTemp + "~@~" + nowDate,true);
